...
with tab1:
    ...
    prompt = st.text_area("Prompt", height=100, key="t2v_prompt")
...
with tab2:
    ...
    flux_prompt = st.text_area("Flux Prompt", height=100, key="joint_flux_prompt")
...
with tab4:
    ...
    prompt = st.text_area("Prompt", height=100, key="i2v_prompt")
